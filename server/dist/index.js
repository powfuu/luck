...
var environment = require("../src/environments/environment").environment;
var port = 3002;
...
var generateToken = function (user) {
    return jwt.sign(user, environment.environment.S3CRET_K3Y0);
};
var validateToken = function (req, res, next) {
    ...
    if (!token) {
        ...
        jwt.verify(token, environment.environment.S3CRET_K3Y0, function (err, user) {
            if (err) {
...
app.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                password = _a.sent();
                signup = "INSERT INTO accounts(email, fullname, password) VALUES(?,?,?)";
                db.query(signup, [email, fullName, password], function (err, result) {
                    if (err) {
                        ...
                        var stats = "INSERT INTO accounts_stats(id) VALUES(?)";
                        db.query(stats, [id]);
                    }
                });
                return [2 /*return*/];
